...
const sectionsTemplate = `
        ...
        <div class="dashboard-grid" style="display: grid; grid-template-columns: 1.2fr 2fr; gap: 30px; margin-top: 20px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 20px;">
                ...
                <div class="debit-card-visual" id="virtualCardVisual">
                    <div class="card-logo">
                        <i class="fas fa-university"></i> HEXCHAL BANK
                    </div>
                ...
                <div style="background: var(--card-bg); padding: 20px; border-radius: 12px; border: 1px solid var(--border-color); box-shadow: var(--shadow);">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <div>
                            ...
                            <h2 style="font-size: 28px; font-weight: 700; margin-top: 5px; color: var(--secondary-color);" id="custBalanceDisplay">Rs. 0.00</h2>
                        </div>
    ...
    <div id="cards" class="section">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1.2fr; gap: 30px; margin-top: 20px;">
            ...
            <div style="background: var(--card-bg); padding: 25px; border-radius: 16px; border: 1px solid var(--border-color); box-shadow: var(--shadow);">
                ...
                <div class="form-group">
                    <label>Daily ATM Withdrawal Limit (Rs.)</label>
                    <input type="number" id="cardAtmLimit" value="20000">
                </div>
                
                <div class="form-group">
                    <label>Daily Online Transaction Limit (Rs.)</label>
    ...
    <!-- Customer Loans & EMI Payment -->
    <div id="customerLoans" class="section">
        <h2><i class="fas fa-credit-card"></i> My Loans / Pay EMI</h2>
        <div id="customerLoanSummary" class="loan-summary-grid" style="margin-top: 20px;"></div>
        <div class="form-group" style="max-width: 260px; margin-top: 20px;">
            <label>4-digit PIN for EMI payment</label>
            <input type="password" id="loanRepayPin" maxlength="4" placeholder="Enter PIN">
        </div>
        <div class="table-container" style="margin-top: 15px;">
            <table class="accounts-table">
                ...
                <tbody id="customerLoansTableBody">
                    <!-- Loaded dynamically by Javascript -->
                </tbody>
            </table>
        </div>
        <div id="customerLoansResult" style="margin-top: 15px;"></div>
    </div>
    ...
    <!-- Staff Active Loans Panel -->
    <div id="activeLoans" class="section">
        ...
        <div id="dashboardContent" style="margin-top: 20px;">
            ...
            <div class="dashboard-stats">
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <h3>Today's Credits</h3>
                        <p id="statTotalDeposits">Rs. 0</p>
                    </div>
                </div>
                <div class="stat-card">
            ...
            <div style="background: var(--card-bg); padding: 20px; border-radius: 10px; border: 1px solid var(--border-color); margin-top: 30px;">
                <h3><i class="fas fa-calendar-day"></i> Date-wise Credits</h3>
                <div class="table-container" style="margin-top: 15px; max-height: 240px; overflow-y: auto;">
                    <table class="accounts-table" style="font-size: 14px; margin: 0;">
                        <thead>
                            <tr>
                                <th>Date</th>
    ...
    <div id="loan" class="section">
        ...
        <div id="emiCalculator" class="emi-calculator" style="display: none;">
            ...
            <div class="emi-result">
                <p><strong>Loan Amount:</strong> Rs. <span id="calcLoanAmount">0</span></p>
                <p><strong>Tenure:</strong> <span id="calcTenure">0</span> months</p>
                <p><strong>Interest Rate:</strong> <span id="calcRate">0</span>%</p>
                <p><strong>Monthly EMI:</strong> Rs. <span id="calcEMI">0</span></p>
                <p><strong>Total Interest Payable:</strong> Rs. <span id="calcTotalInterest">0</span></p>
                <p><strong>Total Payment:</strong> Rs. <span id="calcTotalPayment">0</span></p>
            </div>
        </div>
